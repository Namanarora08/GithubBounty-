    ...
    >
      <Link
        ...
        className={`px-4 py-2 text-sm font-medium transition-all duration-300 rounded-lg relative overflow-hidden ${
          active 
            ? "text-white bg-gradient-to-r from-[#2563eb] to-[#3b82f6] shadow-lg shadow-[#2563eb]/25" 
      ...
      >
        {active && (
          <motion.div
            layoutId="activeTab"
            className="absolute inset-0 bg-gradient-to-r from-[#2563eb] to-[#3b82f6] rounded-lg"
...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className="sticky top-0 z-50 border-b border-white/10 bg-gradient-to-r from-[#0f172a]/95 to-[#0D1117]/95 backdrop-blur-xl supports-[backdrop-filter]:bg-[#0D1117]/70 shadow-lg shadow-black/10"
    >
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-6">
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <Link href="/" className="group flex items-center gap-3">
            <motion.div
              className="rounded-lg bg-gradient-to-br from-[#2563eb] to-[#3b82f6] p-2.5 shadow-lg shadow-[#2563eb]/25"
              whileHover={{
                scale: 1.1,
          ...
          <DropdownMenu open={openNotif} onOpenChange={setOpenNotif}>
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                >
                  <motion.div
                    animate={openNotif ? { rotate: 15 } : { rotate: 0 }}
                    transition={{ type: "spring", stiffness: 400, damping: 25 }}
                  >
                    <Bell className="h-5 w-5" />
                  </motion.div>
                  <motion.span
                    className="absolute right-2 top-2 h-2 w-2 rounded-full bg-[#2563eb]"
                    animate={{
                      scale: [1, 1.3, 1],
                      opacity: [1, 0.7, 1],
                    }}
              ...
              >
                ...
                >
                  <Avatar className="h-8 w-8 ring-1 ring-white/10">
                    ...
                    <AvatarFallback className="bg-gradient-to-br from-[#2563eb] to-[#3b82f6] text-white text-xs font-bold">JD</AvatarFallback>
                  </Avatar>
                  <motion.div
                    animate={openUser ? { rotate: 180 } : { rotate: 0 }}
                    transition={{ type: "spring", stiffness: 400, damping: 25 }}
                  >
              ...
              <Link
                ...
                className={`rounded-lg px-3 py-2 text-sm font-medium transition-all duration-300 ${
                  pathname.startsWith(link.href)
                    ? "text-white bg-gradient-to-r from-[#2563eb] to-[#3b82f6] shadow-lg"
                    : "text-[#C9D1D9] hover:text-white hover:bg-white/10"
                }`}
              >
                {link.label}
